...
from app._shared import (
    _CAT_COLS,
    _avail, _label, _filter_raw, _filter_events,
    _sidebar_filters, _dual_axis_chart,
)
...
# _filter_raw, _sidebar_filters, _dual_axis_chart — imported from app._shared
...
# _filter_events — imported from app._shared
